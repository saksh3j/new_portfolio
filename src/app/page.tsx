    ...
    <main className="min-h-screen selection:bg-primary/10">
      ...
      <section id="hero" className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h1 className="text-reveal mt-12 text-6xl font-extrabold tracking-tighter sm:text-8xl lg:text-9xl">
            {profile.name}
          </h1>
          <p className="text-reveal [animation-delay:200ms] mt-12 text-2xl leading-relaxed text-muted-foreground sm:text-3xl max-w-3xl mx-auto">
            {profile.headline}
          </p>
